...
require_once 'custom/include/beanbuilder/model/AOS_Invoices/AOS_InvoicesShipping_tax.php';
require_once 'custom/include/beanbuilder/model/AOS_Invoices/AOS_InvoicesStatus.php';

class AOS_InvoicesBuilder extends BeanBuilder
{

    function __construct()
    {
        parent::__construct('AOS_Invoices');
    }
    ...
    function quote_number($quote_number = '')
    {
        $this->bean->quote_number = $quote_number;
        return $this;
    }
	
    function quote_date($quote_date = '')
    {
        $this->bean->quote_date = $quote_date;
        return $this;
    }
	
    function invoice_date($invoice_date = '')
    {
        $this->bean->invoice_date = $invoice_date;
        return $this;
    }
	
    function due_date($due_date = '')
    {
        $this->bean->due_date = $due_date;
        return $this;
    }
