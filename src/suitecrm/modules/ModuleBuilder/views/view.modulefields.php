...
class CustomViewModulefields extends ViewModulefields
{
    ...
    function display()
    {
        ...
        if (! isset($_REQUEST['view_package']) || $_REQUEST['view_package'] == 'studio') {
            ...
            global $dictionary;
            $f = array(
                $mod_strings['LBL_HCUSTOM'] => array(),
                $mod_strings['LBL_HDEFAULT'] => array()
            );
            ...
            $ajax->addSection('center', $mod_strings['LBL_EDIT_FIELDS'], $smarty->fetch('custom/modules/ModuleBuilder/tpls/MBModule/fields.tpl'));
            $_REQUEST['field'] = '';
