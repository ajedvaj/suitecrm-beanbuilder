...
<a href="/index.php?module=ModuleBuilder&action=GenerateBuilder&type=studio&view_module={$module->name}" class="button" style="color: white; padding: 9px 20px 9px 20px">GENERATE BUILDER</a>
{/if}
</div>
